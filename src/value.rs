...
macro_rules! impl_to {
    ($name_num:ident, $name_array:ident, $target:ty) => {
        pub fn $name_num(&self) -> Option<$target> {
            match self {
                Value::BOOL(data) => cast_bool(data),
                Value::I8(data) => cast(data),
                Value::U8(data) => cast(data),
                Value::I16(data) => cast(data),
                Value::U16(data) => cast(data),
                Value::I32(data) => cast(data),
                Value::U32(data) => cast(data),
                Value::I64(data) => cast(data),
                Value::U64(data) => cast(data),
                Value::F32(data) => cast(data),
                Value::F64(data) => cast(data),
        ...
        pub fn $name_array(&self) -> Option<Vec<$target>> {
            match self {
                Value::BOOL(data) => cast_bool_arr::<$target>(&vec![*data;1]),
                Value::I8(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::U8(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::I16(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::U16(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::I32(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::U32(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::I64(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::U64(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::F32(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::F64(data) => cast_arr::<_, $target>(&vec![*data;1]),
                Value::ABOOL(data) => cast_bool_arr::<$target>(&data),
                Value::AI8(data) => cast_arr::<_, $target>(&data),
                Value::AU8(data) => cast_arr::<_, $target>(&data),
                Value::AI16(data) => cast_arr::<_, $target>(&data),
                Value::AU16(data) => cast_arr::<_, $target>(&data),
                Value::AI32(data) => cast_arr::<_, $target>(&data),
                Value::AU32(data) => cast_arr::<_, $target>(&data),
                Value::AI64(data) => cast_arr::<_, $target>(&data),
                Value::AU64(data) => cast_arr::<_, $target>(&data),
                Value::AF32(data) => cast_arr::<_, $target>(&data),
                Value::AF64(data) => cast_arr::<_, $target>(&data),
                _ => None,
            }
        }
    };
...
impl Value {
    ...
    {
        match self {
            Value::ASTR(data) => to_str_array::<_>(&data),
            Value::ABOOL(data) => to_str_array::<_>(&data),
            Value::AI8(data) => to_str_array::<_>(&data),
            Value::AU8(data) => to_str_array::<_>(&data),
            Value::AI16(data) => to_str_array::<_>(&data),
            Value::AU16(data) => to_str_array::<_>(&data),
            Value::AI32(data) => to_str_array::<_>(&data),
            Value::AU32(data) => to_str_array::<_>(&data),
            Value::AI64(data) => to_str_array::<_>(&data),
            Value::AU64(data) => to_str_array::<_>(&data),
            Value::AF32(data) => to_str_array::<_>(&data),
            Value::AF64(data) => to_str_array::<_>(&data),
